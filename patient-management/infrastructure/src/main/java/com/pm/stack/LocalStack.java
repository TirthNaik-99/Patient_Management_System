...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props){
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET", "dGhpc2lzYXZlcnlzZWN1cmVzZWNyZXRrZXl0aGF0aXNhdGxlYXN0MzJieXRlc2xvbmc="));
    ...
    private FargateService createFargateService(String id,
        ...
        if(db != null){
            envVars.put("SPRING_DATASOURCE_URL", "jdbc:postgresql://host.docker.internal:%s/%s-db".formatted(
            ...
            envVars.put("SPRING_DATASOURCE_HIKARI_INITIALIZATION_FALL_TIMEOUT", "60000");
        }
